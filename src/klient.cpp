...
const char* Cmds4Obj3[STATES_NUMBER] = {
  "Cube  3 2.5 1.1 -3.5 -1 -3  0 0 0  50 0 255\n",
  "Cube  3 2.5 1.1 -3.5 -1 -3  5 5 0  50 0 255\n",
  "Cube  3 2.5 1.1 -3.5 -1 -3  10 0 0  50 0 255\n",
  "Cube  3 2.5 1.1 -3.5 -1 -3  15 0 0  50 0 255\n",
  "Cube  3 2.5 1.1 -3.5 -1 -3  20 0 0  50 0 255\n"  
 };
